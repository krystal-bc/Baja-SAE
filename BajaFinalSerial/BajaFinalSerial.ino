 ...
 *  
 *  This program reads data from two LIS3DH accelerometers and 2 L3GD20H 3-Axis gyroscopes and saves data to a microSD card
 */
...
void setup(void) {
  ...
  if (SD.begin(SD_CS)) {
    ...
    if (myFile) {
      record = true;
      myFile.println("Acc1_X,Acc1_Y,Acc1_Z,Acc2_X,Acc2_Y,Acc2_Z,Gyro1_X,Gyro1_Y,Gyro1_Z,Gyro2_X,Gyro2_Y,Gyro2_Z,Seconds");
